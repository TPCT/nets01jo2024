                    ...
                    @if ($rows->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($rows as $index => $row)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ substr($row->name, 0, 25) }} @if(strlen($row->name) > 25 )...@endif</td>
                                    <td>{{ substr($row->phone, 0, 11) }}  @if(strlen($row->phone) > 11 )...@endif</td>
                                    <td>{{ substr($row->email, 0, 30) }}  @if(strlen($row->email) > 30 )...@endif</td>
                                    <td>
