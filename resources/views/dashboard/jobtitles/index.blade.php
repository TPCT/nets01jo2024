    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <br/>
              <!--  <form action="{{route('dashboard.'.$module_name_plural.'.import_file')}}" method="post" enctype="multipart/form-data" >
                    @csrf
                    <div class="row">

                        <div class="col-md-4">
                            <input type="file" name="file"  class="form-control" id="file"
                                   placeholder="@lang('site.add_file')">
                        </div>

                        <div class="col-md-4 d-none add_file">
                            <button class="btn btn-success" type="submit"><i class="fa fa-add"></i>
                                @lang('site.add_file')</button>
                        </div>
                    </div>
                </form> --> 
